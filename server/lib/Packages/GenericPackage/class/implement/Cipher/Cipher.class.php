...
class Cipher {
	...
	public static function decrypt($arguments) {
		// 引数のチェック
		if (false === isset($arguments['value']) || 0 === strlen($arguments['value']) || false === isset($arguments['key']) || 0 === strlen($arguments['key']) || false === isset($arguments['iv']) || 0 === strlen($arguments['iv'])) {
			return false;
		}
